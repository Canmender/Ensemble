...
```bash
# 使用 scp 上传
scp -r dist/ package.json package-lock.json root@SERVER_IP_REDACTED:/opt/ensemble/relay-server/

# 或者使用 sftp
sftp root@SERVER_IP_REDACTED
...
# 从外部测试
curl http://SERVER_IP_REDACTED:8888/health
```
