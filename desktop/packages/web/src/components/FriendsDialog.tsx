            ...
            <div className="max-h-80 space-y-1 overflow-y-auto">
              ...
              {candidates.map((u) => (
                <div key={u.id} className="flex items-center gap-3 rounded-lg px-2 py-2 hover:bg-muted/10">
                  <div className={cls("flex h-9 w-9 items-center justify-center rounded-full bg-accent/10 text-accent text-sm font-bold")}>
          ...
          <div className="max-h-80 space-y-1 overflow-y-auto">
            ...
            {requests.map((r) => (
              <div key={r.id} className="flex items-center gap-3 rounded-lg px-2 py-2 hover:bg-muted/10">
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-success/10 text-success text-sm font-bold">
